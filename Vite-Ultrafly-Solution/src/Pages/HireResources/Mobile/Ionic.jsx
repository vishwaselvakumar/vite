  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>
            Hire Ionic Developers | Ultrafly Solutions for Hybrid Apps
          </title>
          <meta
            name="description"
            content="Hire Ionic developers from Ultrafly Solutions to build secure, versatile hybrid mobile apps. Reach your audience on all platforms. Contact us now!"
          />
        </Helmet>
      </HelmetProvider>
      <div
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                  Enhance user engagement with intuitive, user-centric designs that deliver seamless experiences on all platforms.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                  Develop powerful hybrid mobile applications that combine the performance of native apps with the flexibility of web technologies.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                  Keep your Ionic apps running smoothly with our ongoing maintenance and support services.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid sm:grid-cols-2 max-sm:gap-6">
          <div className="text-center p-6 flex flex-col justify-center items-center">
            ...
            <p className="mt-4 text-lg text-gray-800">
              Looking for a custom Ionic solution that scales with your growing business? Get in touch with our expert team to discuss your project needs today.
            </p>
            <Link to={'/contact-us'}>
            <button
              type="button"
      ...
      <div className="py-10 max-md:px-10">
        ...
        <p className="mt-4 max-w-4xl mx-auto text-gray-600">
          Hiring an Ionic developer from Ultrafly Solutions means partnering with a team that excels in delivering innovative, user-friendly mobile applications. We focus on your success with solutions that drive results and boost efficiency.
        </p>
        ...
        <div className="mt-6 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-8 shadow-lg rounded-lg bg-white flex-1 transition-transform transform hover:scale-105 border border-sky-400" data-aos="fade-right">
            ...
            <p className="text-gray-600">
              Our Ionic developers bring years of hands-on experience, consistently delivering scalable and high-performing mobile applications across industries.
            </p>
          </div>
          ...
          <div className="p-8 shadow-lg rounded-lg bg-white flex-1 transition-transform transform hover:scale-105 border border-sky-400" data-aos="flip-up">
            ...
            <p className="text-gray-600">
              We leverage the latest Ionic tools and technologies to build cutting-edge applications that enhance user experiences and boost operational efficiency.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-4 md:justify-between">
          ...
          <div className=" border-blue-600 max-md:border-b-[3px] max-md:border-l-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 md:border-t-[3px] border-blue-600  p-10">
              ...
              <p className=" ">
                enefit from our expertise as we recommend the best tools, technologies, and development approaches for your project.
              </p>
            </div>
          </div>
          {/* <div className="divider md:divider-horizontal" /> */}
          <div className=" border-blue-600 border-b-[3px] max-md:border-r-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 md:border-x-[3px] border-blue-600 p-10">
              ...
              <p className=" ">
                Work closely with our developers, ensuring your vision comes to life with high-quality, innovative solutions.
              </p>
            </div>
          </div>
          {/* <div className="divider md:divider-horizontal" /> */}
        ...
        <div className="pl-10 text-neutral-content text-left items-start py-10 ">
          <div className="">
            ...
            <p className="mb-5 text-xs md:text-xl text-white w-3/4">
              At Ultrafly Solutions, we’re dedicated to delivering Ionic app solutions that give your business a competitive edge. Our developers bring a results-driven approach, ensuring your mobile applications deliver efficiency and value.
              Contact us now to hire an Ionic developer and kickstart your project.
            </p>
