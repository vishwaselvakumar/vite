  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>
            Hire ReactJS Developers | Ultrafly Solutions for Frontend Apps{" "}
          </title>
          <meta
            name="description"
            content="Hire ReactJS developers from Ultrafly Solutions to build fast, scalable frontend apps. Boost your digital experience. Contact us to get started today!"
          />
        </Helmet>
      </HelmetProvider>
      <div
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                Craft responsive, high-performance web applications using the latest ReactJS libraries and tools.
                </p>  
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                Build scalable enterprise-level applications that streamline operations and increase productivity.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                Leverage the power of ReactJS to create intuitive, engaging, and highly interactive user interfaces.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
                Build Single Page Applications (SPA) and Progressive Web Apps (PWA) to deliver seamless, fast, and engaging user experiences.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 mx-auto max-w-md">
              ...
              <div class="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p class="font-medium group-hover:text-gray-100">
               Keep your ReactJS applications running smoothly with our ongoing support and maintenance services.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gray-50 relative max-w-full shadow-sm shadow-[#000000] mx-auto rounded overflow-hidden">
        <div className="grid sm:grid-cols-2 max-sm:gap-6">
          <div className="text-center p-6 flex flex-col justify-center items-center">
            ...
            Looking for a custom ReactJS solution that scales with your growing business? Get in touch with our expert team to discuss your project needs today.
            </p>
            <Link to={'/contact-us'}>
              <button
                type="button"
      ...
      <div className="py-10 max-md:px-10">
        ...
        Hiring a ReactJS developer from Ultrafly Solutions means partnering with a team that excels in delivering innovative, user-friendly applications. We focus on your success with solutions that drive results and increase efficiency.
        </p>
        ...
        <div className="mt-6 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-8 shadow-lg rounded-lg bg-white flex-1 transition-transform transform hover:scale-105 border border-sky-400" data-aos="fade-left">
            ...
            We ensure full transparency throughout the project lifecycle, keeping you informed and involved at every stage.
            </p>
          </div>
          ...
          <div className="p-8 shadow-lg rounded-lg bg-white flex-1 transition-transform transform hover:scale-105 border border-sky-400" data-aos="flip-up">
            ...
            <p className="text-gray-600">
            Whether you need a full-time developer, part-time support, or project-based assistance, our flexible hiring models adapt to your needs.
            </p>
          </div>
          ...
          <div className="p-8 shadow-lg rounded-lg bg-white flex-1 transition-transform transform hover:scale-105 border border-sky-400" data-aos="fade-right">
            ...
            <p className="text-gray-600">
            Our ReactJS developers bring years of hands-on experience, consistently delivering scalable and high-performing applications across industries.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-4 md:justify-between">
          <div className=" relative border-blue-600 border-b-[3px] max-md:border-r-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 md:border-r-[3px] border-blue-600 p-10">
              ...
              <p className=" ">
              We take the time to understand your ideas in detail, engaging in deep discussions to clarify your project goals and expectations.
              </p>
            </div>
          ...
          <div className=" border-blue-600 max-md:border-b-[3px] max-md:border-l-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 md:border-t-[3px] border-blue-600  p-10">
              ...
              <p className=" ">
              Benefit from our expertise as we recommend the best tools, technologies, and development approaches for your project.
              </p>
            </div>
          </div>
          {/* <div className="divider md:divider-horizontal" /> */}
          ...
          <div className=" border-blue-600 max-md:border-l-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 relative md:border-t-[3px] border-blue-600 p-10">
              ...
              <p className=" ">
              We provide continuous collaboration and support throughout the project to ensure everything runs smoothly and meets your objectives.
              </p>
      ...
      >
        ...
        <div className="pl-10 text-neutral-content text-left items-start py-10 ">
          <div className="">
            ...
            At Ultrafly Solutions, we’re dedicated to delivering ReactJS solutions that give your business a competitive edge. Our developers bring a results-driven approach, ensuring your software delivers efficiency and value. Contact us now to hire a ReactJS developer and kickstart your project.
            </p>
        ...
        <div className="col-span-2 grid gap-2 ">
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-content">
              <p>
              Our ReactJS developers bring years of experience in building dynamic, scalable, and high-performing applications. We focus on delivering secure and tailored solutions to fit 
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
            What type of applications can your ReactJS developers build?</div>
            <div className="collapse-content">
              <p>
